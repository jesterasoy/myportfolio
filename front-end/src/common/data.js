const myProjectsData = [
  ...
  },
  {
    ...
    Description:
      'Movie Finder is a simple yet powerful web application that lets users search for movies and view detailed information using the TMDB API. It features a clean interface built with HTML, CSS, and JavaScript.\n\nUsers can search by title and get instant results, including movie posters, release dates, genres, and summaries. This project highlights my experience working with third-party APIs and creating dynamic, user-friendly applications using core frontend technologies.',
