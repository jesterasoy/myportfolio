...
const FirstSection = () => {
  ...
  return (
    <>
      <div>
        <section className="-mt-6 xs:-mt-10 2xl:mt-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3">
            <div className="flex flex-col items-start h-100 justify-center sora text-balance col-span-2 -mt-[9rem] md:-mt-[5rem] lg:-mt-[3rem] 2xl:mt-[2.5rem]">
              <h1
                className="font-bold text-base xs:text-xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl tracking-wide"
                ref={textRef}
              >
                Hello I'm{" "}
              ...
              <div className="absolute top-[110px] md:top-[150px] lg:top-[190px] 2xl:top-[300px] left-[130px] md:left-[185px] lg:left-[200px] xl:left-[260px] 2xl:left-[520px] -z-10 h-[20px] w-[90px] md:w-[120px] lg:h-[55px] xl:h-[65px] lg:w-[160px] xl:w-[200px] 2xl:w-[240px] bg-[#F4CE14] opacity-30 blur-md"></div>
              <h1
                ref={subTextRef}
                className="font-bold text-base xs:text-xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl tracking-wide flex items-center gap-3"
              >
                Aspiring
                <span>
                  <Typwriter
              ...
              <p
                ref={subTextRef}
                className="mt-4 text-[0.7rem] xs:text-sm md:text-lg 2xl:text-lg lg:text-[15px] text-gray-600 leading-relaxed"
              >
            ...
            <div className="relative w-full h-[160px] xs:h-[200px] md:h-[300px] lg:h-[360px] xl:h-[450px] mx-auto -mt-[6rem] mb-5 sm:mt-0 md:mb-0 lg:mb-0 2xl:mb-0">
              <img
                ref={imageRef}
          ...
          <div className="relative sora tracking-wide mb-[3rem] xs:mb-[5rem] lg:mb-[8rem] 2xl:mb-[15rem]">
